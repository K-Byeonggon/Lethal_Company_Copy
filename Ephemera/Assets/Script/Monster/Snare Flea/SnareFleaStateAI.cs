...
public class SnareFleaFallingState : IMonsterState
{
    ...
    public void Update()
    {
        ...
        if (monster.IsGround())
        {
            monster.ChangeState(new SnareFleaTracingState(monster));
        }
    }
...
public class SnareFleaTracingState : IMonsterState
{
    private SnareFleaStateAI monster;
    private LivingEntity playerHealth;

    public SnareFleaTracingState(SnareFleaStateAI monster)
    {
        this.monster = monster;
    }
